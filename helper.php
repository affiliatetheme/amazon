 ...
 */
add_filter('at_product_api_button_short_text', 'at_overwrite_amazon_product_button_short_text', 10, 5);
...
add_filter('at_product_api_button_text', 'at_overwrite_amazon_product_button_text', 10, 5);
